...
const NAV_ITEMS = [
  { key: "notices",     icon: NotificationsIcon, href: "/staff/notices" },
  { key: "attendance",  icon: AccessTimeIcon,    href: "/staff/attendance" },
  { key: "handover",    icon: AssignmentIcon,    href: "/staff/handover" },
  { key: "awards",      icon: EmojiEventsIcon,   href: "/staff/awards" },
  { key: "suggestions", icon: ChatIcon,          href: "/staff/suggestions" },
] as const;

type Props = { userName: string };

export default function StaffSidebar({ userName }: Props) {
