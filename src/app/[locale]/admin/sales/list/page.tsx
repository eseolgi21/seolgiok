    ...
    return (
        <div className="space-y-6">
                ...
                <Card>
                    <CardContent className="p-4">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                            ...
                            <div className="space-y-1">
                                <Label>결제수단 컬럼</Label>
                                <Input className="h-8 text-sm" value={mapping.payment} onChange={e => setMapping({ ...mapping, payment: e.target.value })} />
                            </div>
                            <div className="space-y-1">
                                <Label>비고 컬럼</Label>
            ...
            <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>매출 내역 직접 추가</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                            <Label>분류</Label>
                            <Input type="text" placeholder="예: 매장, 배달" value={newItem.category} onChange={e => setNewItem({ ...newItem, category: e.target.value })} />
                        </div>
                        <div className="space-y-1">
                            <Label>상품명</Label>
                            <Input type="text" placeholder="예: 아메리카노" value={newItem.itemName} onChange={e => setNewItem({ ...newItem, itemName: e.target.value })} />
                        </div>
                        <div className="space-y-1">
                            <Label>금액</Label>
                        ...
                        <div className="space-y-1">
                            <Label>결제수단</Label>
                            <Input type="text" placeholder="예: 카드, 현금" value={newItem.paymentMethod} onChange={e => setNewItem({ ...newItem, paymentMethod: e.target.value })} />
                        </div>
                        <div className="space-y-1">
                            <Label>비고</Label>
