                ...
                <Card>
                    <CardContent className="p-4">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                            ...
                            <div className="space-y-1">
                                <Label>{t("mapping.colPayment")}</Label>
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-muted border-0">
                            ...
                            <TableHead>{t("table.colPayment")}</TableHead>
            ...
            <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
                <DialogContent>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                            <Label>{t("addModal.labelPayment")}</Label>
                            <Input type="text" placeholder={t("addModal.placeholderPayment")} value={newItem.paymentMethod} onChange={e => setNewItem({ ...newItem, paymentMethod: e.target.value })} />
                        </div>
                        <div className="space-y-1">
