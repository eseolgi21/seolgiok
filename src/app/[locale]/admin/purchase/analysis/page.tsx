    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="card bg-primary text-primary-foreground shadow-sm p-4">
                    <div className="stat p-0">
                        <div className="stat-title text-primary-foreground/80">총 매입 금액</div>
                        <div className="stat-value text-2xl">{metadata.totalSpending.toLocaleString()}원</div>
                        <div className="stat-desc text-primary-foreground/80">총 {metadata.totalCount}건</div>
                    </div>
                </div>
            </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="text-right">총 매입금액</TableHead>
                            ...
                            items.map((item) => {
                                ...
                                return (
                                    <TableRow key={`${item.itemName}-${item.category}`}>
                                        ...
                                        <TableCell className="text-right">{item.averageAmount.toLocaleString()}원</TableCell>
                                        <TableCell className="text-right font-bold">{item.totalAmount.toLocaleString()}원</TableCell>
                                        <TableCell>
                                            <div className="flex items-center gap-2">
